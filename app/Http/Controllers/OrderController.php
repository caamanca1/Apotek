...
class OrderController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $orders = Order::with('user')->where('created_at','LIKE',"%".$Date."%")->paginate(10);
    ...
    public function store(Request $request)
    {
        ...
        // mencari item yang sama pada array, strukturnya :
        // [ "item" => "jumlah" ]
    ...
    public function downloadPDF($id) {
        // ambil data yang diperlukan, dan pastikan berformat array
