...
@push('script')
    <script>
        ...
        let no = 2;
        // ketika tag dengan id add-select di click jalankan fungsi berikut
        $("#add-select").on("click", function() {
            ...
            // append : tambahkan element html dibagian sblm penutup tag penutup terkain (sblm penutup tag yg idnya wrap-medicines)
