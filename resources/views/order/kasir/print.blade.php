    ...
    <div id="receipt">
        <a href="{{ route('kasir.order.download', $order['id']) }}" class="btn-print">Cetak (.pdf)</a>
            ...
            <div id="bot">
                ...
                <div id="legalcopy">
                    <p class="legal"><strong>Terimakasih atas pembelian Anda!</strong> Lorem ipsum dolor sit amet consectetur adipisicing elit. Nemo quibusdam nobis quo modi, officiis harum optio nihil accusamus.
                    </p>
                </div>
            </div>
    </div>
